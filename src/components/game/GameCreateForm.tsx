...
const GameCreateForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validate date
    const gameDate = new Date(formData.startDateTime);
    ...
    try {
      const response = await fetch('/api/games', {
        ...
        body: JSON.stringify({
          ...
          dateTime: new Date(formData.startDateTime),
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <select
            ...
            required
          >
            <option value="venue_1">Venue 1</option>
        ...
        <div className="grid grid-cols-3 gap-4 mb-4">
          ...
          <div>
            <label className="block text-gray-700 mb-2">Price (R)</label>
            <input
              type="number"
              name="price"
